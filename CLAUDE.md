...
| | |
|---|---|
| **בדיקות** | **613 עוברות, 0 נכשלות** (`npm test`, 30 קבצים) · voice 0 שגיאות · demo 17/17 · preflight 65/65 · **עומס: מיליון הודעות** |
