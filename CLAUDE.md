...
| | |
|---|---|
| **בדיקות** | **533 עוברות, 0 נכשלות** (`npm test`, 23 קבצים) · voice 0 שגיאות · demo 17/17 · preflight 65/65 · **עומס: מיליון הודעות** |
...
| פקודה | מה היא עושה |
|---|---|
| `npm test` | **533 בדיקות ב-23 קבצים** — `e2e` · `places` · `safety` · `scale` · `idsecurity` · `hoteltype` · `tenant-isolation` · `demo-switch` · `demo-bootstrap` · `pms-optima` · `pms-vendors` · `store` · `voice` · `persistence` · `payments` · `all-hotels` · `lru` · `readthrough` · `pgpath` · `escalation` · `settlement` · `httpasync` · **`jobs`** |
