...
| | |
|---|---|
| **בדיקות** | **548 עוברות, 0 נכשלות** (`npm test`, 24 קבצים) · voice 0 שגיאות · demo 17/17 · preflight 65/65 · **עומס: מיליון הודעות** |
...
| פקודה | מה היא עושה |
|---|---|
| `npm test` | **548 בדיקות ב-24 קבצים** — `e2e` · `places` · `safety` · `scale` · `idsecurity` · `hoteltype` · `tenant-isolation` · `demo-switch` · `demo-bootstrap` · `pms-optima` · `pms-vendors` · `store` · `voice` · `persistence` · `payments` · `all-hotels` · `lru` · `readthrough` · `pgpath` · `escalation` · `settlement` · `httpasync` · `jobs` · **`schedule`** |
